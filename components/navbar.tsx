...
export default function Navbar({}): any {
    return (
        <nav className="w-full backdrop-blur-md bg-background bg-opacity-30 z-50 fixed h-24 flex justify-between items-center py-10 px-4 md:px-8 lg:px-12 xl:px-16 2xl:px-24">
            <Link href="/">
                <Image alt="logo" className="cursor-pointer w-16" src="/images/logo.png" height={100} width={170} />
            </Link>
            ...
            <div className="hidden md:flex items-center gap-2">
                <ModeToggle />
                <Link href="https://github.com/fatihes1/file-converter">
                    <Button
                        variant="default"
                        className="rounded-full w-fit bg-blue-400 gap-2 items-center hidden md:flex"
                        size="lg"
                    >
